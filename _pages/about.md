...
⛹️‍♂️Ji-Zhe ZHOU or Chow, Kat-Chit (周吉喆)🏊‍♂️, Associate Professor at the School of Computer Science, Sichuan University. I obtained my B.Sc., M.Sc., and Ph.D. (early graduation) from the University of Macau. My primary research areas are the self-supervised learning theories and multimedia content security. I am the leader and supervisor of many influential works, including NCL-IML, IMDL-BenCo, SparseViT, ForensicHub, etc. My publication recieved a total <a href='https://scholar.google.com/citations?user=-cNWmJMAAAAJ'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a> citations.   
...
# 🔥 News   
- *2026.02* ``Publication``: 🎉🎉[SICA](https://arxiv.org/pdf/2602.06676)![Stars](https://img.shields.io/github/stars/scu-zjz/SICA_OpenMMSec?style=social), we present the first FIDL model—SICA, which adopts a monolithic architecture and outperforms all domain-specific models in their respective domains (e.g., higher deepfake detection accuracy than Effort, higher IML accuracy than SparseViT, etc.). SICA achieves the best-ever performance for practical image forensics tasks. Supported by our co-authors, a public trial version of SICA, developed by Ant Group, will be made publicly available very soon.   
- *2026.01* ``A&S Service``: 🎉🎉Promoted as the *Associate Editor* for *TETCI*---*IEEE Transactions on Emerging Topics in Computational Intelligence*.    
- *2026.01* ``Publication``: &nbsp;[*TMM*]🎉🎉[PASK](https://ieeexplore.ieee.org/abstract/document/11329505), our work on the sparse learning for adversarial example crafting is accepted to IEEE Transactions on Multimedia.    
- *2026.01* ``A&S Service``: 🎉🎉Promoted as the *Area Chair* for *ICML 2026*.    
- *2025.12* ``Publication``: &nbsp;[*AAAI 2026*]🎉🎉 [FGM-HD](https://arxiv.org/abs/2511.08945), we introduce the classic Hausdorff Dimension into Fractal Generation Model, and the code will be available!   
- *2025.11* ``Publication``: &nbsp;[*TDSC*]🎉🎉[Defensive Adversarial CAPTCHA](https://ieeexplore.ieee.org/abstract/document/11267085), our work on the semantics-driven framework for natural adversarial example generation is accepted to IEEE Transactions on Dependable and Secure Computing.   
- *2025.10* ``Publication``: &nbsp;[*TDSC*]🎉🎉[IO-RAE](https://arxiv.org/abs/2601.01239), our work on adversarial privacy is accepted to IEEE Transactions on Dependable and Secure Computing.   
